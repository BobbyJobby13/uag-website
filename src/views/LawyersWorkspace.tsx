  ...
  if (!allowed) {
    return (
      <ServiceRequestForm
        ...
        descriptionPlaceholder="Describe your legal issue, the parties involved, and what you need..."
      />
    )
  }
  ...
  return (
    <div className="page">
      <header className="page-header">
        <h1 className="page-title">Legal Department</h1>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Panel className="lg:col-span-1">
          ...
          {legalStaff.length === 0 ? (
            <p className="text-sm text-[#8b92a8]">No legal staff listed. Assign roles in Role Manager.</p>
          ) : (
